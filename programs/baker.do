...
areg y2 i.year dd2 - dd20 dd22-dd23 dd25-dd48, a(id) robust 

coefplot, keep(dd1 dd2 dd3 dd4 dd5 dd6 dd7 dd8 dd9 dd10 dd11 dd12 dd13 dd14 dd15 dd16 dd17 dd18 dd19 dd20 dd22 dd23 dd25 dd26 dd27 dd28 dd29 dd30 dd31 dd32 dd33 dd34 dd35 dd36 dd37 dd38 dd39 dd40 dd41 dd42) xlabel(, angle(vertical)) yline(0) vertical msymbol(D) mfcolor(white) ciopts(lwidth(*3) lcolor(*.6)) grid(between) mlabel format(%9.3f) mlabposition(12) mlabgap(*2) title(Baker simulation) 

* Event study with constant treatment effects, no anticipatory behavior and parallel trends (Sun and Abraham 2020). Droppping two leads.
* Interact group cohorts with relative time
ta time_til if time_til<-1, gen(leads)
ta time_til if time_til>0, gen(lags)
...
areg y2 i.abs_lead_til##i.group i.lag_til##i.group, a(id) robust

areg y2 i.year dd1 - dd22 dd25-dd48, a(id) robust 
...
* Drop variable so I can copy paste this code!
**************************************************************************************************************************************
capture drop ypost ypre g1_mean g1_cont_1997mean w1 w0 att_*
...
* ATT(1992,1992)= 8
* Drop variable so I can copy paste this code!
drop ypost ypre g2_mean g2_cont_2003mean w1 w0 att_*

* I think now you know how to do the rest! =)


*********************************************************************************
* RSOURCE: Call the R code
*********************************************************************************

* ssc install rsource, replace
* github install haghish/rcall, stable

use ../data/baker.dta, clear

if "`c(os)'"=="MacOSX" | "`c(os)'"=="UNIX" {
    rsource using baker_cs.R, rpath("/usr/local/bin/R") roptions(`"--vanilla"')
}
else {  // windows
    rsource using baker_cs.R, rpath(`"c:\r\R-3.5.1\bin\Rterm.exe"') roptions(`"--vanilla"')  // change version number, if necessary
}
...
staggered, y("y") g("treat_date") t("year") i("id") estimand("simple")
staggered_cs, y("y2") g("treat_date") t("year") i("id") estimand("simple")
staggered_sa, y("y2") g("treat_date") t("year") i("id") estimand("cohort")
